...
- 2026-07-30 起：圆角半径约 18%（约 1454 源图下 262px）；8% 透明外扩安全边；详细圆角锚点见 `docs/icon-design-v1.png`；生成脚本 `scripts/build-icons.mjs`。主体（灯塔+纸叠+暖光）保留原始位；主色收敛愿景留待后续 brand 收口 ISS。
